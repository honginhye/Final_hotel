...
public class RevenueServiceimple implements RevenueService {
    ...
    @Override
    public Map<String, Object> getRevenueSummary(Map<String, String> paraMap) {
    ...
    @Override
    public List<Map<String, Object>> getDailyRevenue(Map<String, String> paraMap) {
    ...
    @Override
    public List<Map<String, Object>> getRoomTypePortion(Map<String, String> paraMap) {
    ...
    @Override
    public List<Map<String, Object>> getMonthlyPaymentList(Map<String, String> paraMap) {
