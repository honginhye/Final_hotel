...
public interface RevenueDAO {
     ...
     */
    Map<String, Object> selectRevenueSummary(String month);

    /**
     * 차트용 일별 매출 추이
     * 반환 Key: PAID_DAY, DAILY_REVENUE
     */
    List<Map<String, Object>> selectDailyRevenue(String month);

    /**
     * 객실 등급별 매출 비중 (도넛 차트용)
     * 반환 Key: ROOM_TYPE, TYPE_REVENUE
     */
    List<Map<String, Object>> selectRoomTypePortion(String month);

    /**
     * 결제 상세 내역 (테이블용)
     * 반환 Key: PAID_AT, PAYMENT_ID, MEMBER_NAME, PAYMENT_AMOUNT, PAYMENT_STATUS
     */
    List<Map<String, Object>> selectMonthlyPaymentList(String month);
}